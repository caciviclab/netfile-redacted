...
'''
This uploader class will upload files from a local source directory to a target 
directory of on Google Drive.  The following has to be done to set up
for this:
...
copier = Copier('netfile_redacted')
